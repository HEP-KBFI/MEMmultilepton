#ifndef MEPHASESPACE_CPP
#define MEPHASESPACE_CPP
...
void MEPhaseSpace::InitializeLHAPDF(string pdfName){

  //Initialise LHAPDF
  LHAPDF::setVerbosity(verbosity);

  //pdf = LHAPDF::mkPDF("NNPDF23_lo_as_0119_qed",0);
  //pdf = LHAPDF::mkPDF("NNPDF30_lo_as_0118",0);
  pdf = LHAPDF::mkPDF(pdfName.c_str(), 0);

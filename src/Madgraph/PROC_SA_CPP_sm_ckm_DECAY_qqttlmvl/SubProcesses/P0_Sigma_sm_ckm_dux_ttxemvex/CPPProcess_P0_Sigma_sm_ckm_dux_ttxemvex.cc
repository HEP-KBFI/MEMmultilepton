...
#include "CPPProcess_P0_Sigma_sm_ckm_dux_ttxemvex.h"
...
void CPPProcess_P0_Sigma_sm_ckm_dux_ttxemvex::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_dux_ttxemvex::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_dux_ttxemvex::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_dux_ttxemvex::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_2(w[0], w[7], pars->GC_100, pars->ZERO, pars->ZERO, w[9]); 
...
double CPPProcess_P0_Sigma_sm_ckm_dux_ttxemvex::matrix_dux_ttxemvex() 
{
  int i, j; 
  // Local variables
  const int ncolor = 2; 

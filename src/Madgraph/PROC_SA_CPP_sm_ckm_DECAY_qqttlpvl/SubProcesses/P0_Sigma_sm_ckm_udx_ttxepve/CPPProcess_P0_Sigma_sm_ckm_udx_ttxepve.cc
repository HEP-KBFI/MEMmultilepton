...
#include "CPPProcess_P0_Sigma_sm_ckm_udx_ttxepve.h"
...
// Process: u d~ > t t~ e+ ve WEIGHTED=6
// Process: u d~ > t t~ mu+ vm WEIGHTED=6
// Process: c s~ > t t~ e+ ve WEIGHTED=6
// Process: c s~ > t t~ mu+ vm WEIGHTED=6

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_P0_Sigma_sm_ckm_udx_ttxepve::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_udx_ttxepve::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_udx_ttxepve::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_udx_ttxepve::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_ckm_udx_ttxepve::matrix_udx_ttxepve() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 

...
#include "CPPProcess_P0_Sigma_sm_ckm_cdx_ttxepve.h"
...
// Process: c d~ > t t~ e+ ve WEIGHTED=6
// Process: c d~ > t t~ mu+ vm WEIGHTED=6

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_P0_Sigma_sm_ckm_cdx_ttxepve::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_cdx_ttxepve::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_cdx_ttxepve::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_cdx_ttxepve::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_ckm_cdx_ttxepve::matrix_cdx_ttxepve() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 

...
#include "CPPProcess_P0_Sigma_sm_ckm_gcx_ttxemvexgdx.h"
...
void CPPProcess_P0_Sigma_sm_ckm_gcx_ttxemvexgdx::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gcx_ttxemvexgdx::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gcx_ttxemvexgdx::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gcx_ttxemvexgdx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_ckm_gcx_ttxemvexgdx::matrix_gcx_ttxemvexgdx() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 

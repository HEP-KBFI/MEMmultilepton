...
#include "CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgu.h"
...
void CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgu::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgu::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgu::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgu::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_1(w[7], w[10], pars->GC_100, pars->ZERO, pars->ZERO, w[12]); 
  FFV2_2(w[1], w[10], pars->GC_100, pars->ZERO, pars->ZERO, w[13]); 
  ...
  FFV2_1(w[25], w[10], pars->GC_100, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV2_2(w[28], w[10], pars->GC_100, pars->ZERO, pars->ZERO, w[29]); 
  ...
  FFV2_1(w[44], w[10], pars->GC_100, pars->ZERO, pars->ZERO, w[45]); 
  ...
  FFV2_2(w[51], w[10], pars->GC_100, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV2_0(w[15], w[14], w[10], pars->GC_100, amp[2]); 
  FFV1_0(w[13], w[14], w[9], pars->GC_11, amp[3]); 
  FFV2_0(w[16], w[17], w[10], pars->GC_100, amp[4]); 
  ...
  FFV2_0(w[28], w[48], w[10], pars->GC_100, amp[40]); 
  FFV1_0(w[28], w[45], w[9], pars->GC_11, amp[41]); 
  FFV2_0(w[15], w[49], w[10], pars->GC_100, amp[42]); 
  ...
  FFV2_0(w[53], w[25], w[10], pars->GC_100, amp[52]); 
  FFV1_0(w[52], w[25], w[9], pars->GC_11, amp[53]); 
  FFV2_0(w[54], w[17], w[10], pars->GC_100, amp[54]); 
  ...
  FFV2_0(w[15], w[63], w[10], pars->GC_100, amp[72]); 
  ...
  FFV2_0(w[66], w[17], w[10], pars->GC_100, amp[78]); 
...
double CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgu::matrix_gd_ttxemvexgu() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 

...
#include "CPPProcess_P0_Sigma_sm_ckm_gux_ttxemvexgdx.h"
...
void CPPProcess_P0_Sigma_sm_ckm_gux_ttxemvexgdx::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gux_ttxemvexgdx::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gux_ttxemvexgdx::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gux_ttxemvexgdx::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_1(w[1], w[10], pars->GC_100, pars->ZERO, pars->ZERO, w[12]); 
  FFV2_2(w[7], w[10], pars->GC_100, pars->ZERO, pars->ZERO, w[13]); 
...
double CPPProcess_P0_Sigma_sm_ckm_gux_ttxemvexgdx::matrix_gux_ttxemvexgdx() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 

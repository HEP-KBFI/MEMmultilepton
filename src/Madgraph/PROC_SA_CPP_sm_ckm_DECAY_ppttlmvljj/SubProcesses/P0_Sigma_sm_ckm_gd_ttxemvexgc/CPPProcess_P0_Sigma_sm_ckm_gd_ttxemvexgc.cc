...
#include "CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgc.h"
...
void CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgc::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgc::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgc::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgc::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_1(w[7], w[10], pars->GC_44, pars->ZERO, pars->ZERO, w[12]); 
  FFV2_2(w[1], w[10], pars->GC_44, pars->ZERO, pars->ZERO, w[13]); 
...
double CPPProcess_P0_Sigma_sm_ckm_gd_ttxemvexgc::matrix_gd_ttxemvexgc() 
{
  int i, j; 
  // Local variables

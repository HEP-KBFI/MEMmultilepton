...
#include "CPPProcess_P0_Sigma_sm_ckm_gs_ttxemvexgu.h"
#include "../../src/HelAmps_sm_ckm_ppttlmvljj.h"

using namespace MG5_sm_ckm_ppttlmvljj; 

//==========================================================================
// Class member functions for calculating the matrix elements for
// Process: g s > t t~ e- ve~ g u WEIGHTED=8
// Process: g s > t t~ mu- vm~ g u WEIGHTED=8

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_P0_Sigma_sm_ckm_gs_ttxemvexgu::initProc(string param_card_name) 
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_ckm_ppttlmvljj::getInstance(); 
...
void CPPProcess_P0_Sigma_sm_ckm_gs_ttxemvexgu::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gs_ttxemvexgu::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gs_ttxemvexgu::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3(w[5], w[4], pars->GC_108, pars->mdl_MW, pars->mdl_WW, w[10]); 
  VVV1P0_1(w[8], w[9], pars->GC_10, pars->ZERO, pars->ZERO, w[11]); 
  FFV2_1(w[7], w[10], pars->GC_101, pars->ZERO, pars->ZERO, w[12]); 
  FFV2_2(w[1], w[10], pars->GC_101, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_1(w[7], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_2(w[1], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_2(w[1], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_1(w[7], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  ...
  FFV2_1(w[25], w[10], pars->GC_101, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV2_2(w[28], w[10], pars->GC_101, pars->ZERO, pars->ZERO, w[29]); 
  ...
  FFV1_2(w[1], w[26], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_1(w[7], w[26], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  ...
  FFV1_2(w[1], w[38], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1_1(w[7], w[38], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_1(w[7], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV2_1(w[44], w[10], pars->GC_101, pars->ZERO, pars->ZERO, w[45]); 
  ...
  FFV1_2(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV2_2(w[51], w[10], pars->GC_101, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_2(w[1], w[64], pars->GC_11, pars->ZERO, pars->ZERO, w[69]); 
  FFV1_1(w[7], w[64], pars->GC_11, pars->ZERO, pars->ZERO, w[70]); 
  ...
  FFV1_0(w[1], w[12], w[11], pars->GC_11, amp[0]); 
  FFV1_0(w[13], w[7], w[11], pars->GC_11, amp[1]); 
  FFV2_0(w[15], w[14], w[10], pars->GC_101, amp[2]); 
  FFV1_0(w[13], w[14], w[9], pars->GC_11, amp[3]); 
  FFV2_0(w[16], w[17], w[10], pars->GC_101, amp[4]); 
  FFV1_0(w[16], w[12], w[9], pars->GC_11, amp[5]); 
  FFV1_0(w[13], w[17], w[8], pars->GC_11, amp[6]); 
  FFV1_0(w[15], w[12], w[8], pars->GC_11, amp[7]); 
  FFV1_0(w[1], w[12], w[19], pars->GC_11, amp[8]); 
  FFV1_0(w[13], w[7], w[19], pars->GC_11, amp[9]); 
  FFV1_0(w[1], w[12], w[21], pars->GC_11, amp[10]); 
  FFV1_0(w[13], w[7], w[21], pars->GC_11, amp[11]); 
  FFV1_0(w[1], w[12], w[24], pars->GC_11, amp[12]); 
  FFV1_0(w[13], w[7], w[24], pars->GC_11, amp[13]); 
  FFV1_0(w[1], w[27], w[26], pars->GC_11, amp[14]); 
  FFV1_0(w[13], w[25], w[26], pars->GC_11, amp[15]); 
  FFV1_0(w[29], w[7], w[26], pars->GC_11, amp[16]); 
  FFV1_0(w[28], w[12], w[26], pars->GC_11, amp[17]); 
  FFV1_0(w[1], w[12], w[31], pars->GC_11, amp[18]); 
  FFV1_0(w[13], w[7], w[31], pars->GC_11, amp[19]); 
  FFV1_0(w[1], w[12], w[32], pars->GC_11, amp[20]); 
  FFV1_0(w[33], w[12], w[6], pars->GC_11, amp[21]); 
  FFV1_0(w[13], w[7], w[32], pars->GC_11, amp[22]); 
  FFV1_0(w[13], w[34], w[6], pars->GC_11, amp[23]); 
  FFV1_0(w[1], w[12], w[37], pars->GC_11, amp[24]); 
  FFV1_0(w[13], w[7], w[37], pars->GC_11, amp[25]); 
  FFV1_0(w[1], w[27], w[38], pars->GC_11, amp[26]); 
  FFV1_0(w[13], w[25], w[38], pars->GC_11, amp[27]); 
  FFV1_0(w[29], w[7], w[38], pars->GC_11, amp[28]); 
  FFV1_0(w[28], w[12], w[38], pars->GC_11, amp[29]); 
  FFV1_0(w[1], w[12], w[40], pars->GC_11, amp[30]); 
  FFV1_0(w[13], w[7], w[40], pars->GC_11, amp[31]); 
  FFV1_0(w[1], w[12], w[41], pars->GC_11, amp[32]); 
  FFV1_0(w[42], w[12], w[6], pars->GC_11, amp[33]); 
  FFV1_0(w[13], w[7], w[41], pars->GC_11, amp[34]); 
  FFV1_0(w[13], w[43], w[6], pars->GC_11, amp[35]); 
  FFV1_0(w[1], w[45], w[46], pars->GC_11, amp[36]); 
  FFV1_0(w[13], w[44], w[46], pars->GC_11, amp[37]); 
  FFV1_0(w[1], w[45], w[47], pars->GC_11, amp[38]); 
  FFV1_0(w[13], w[44], w[47], pars->GC_11, amp[39]); 
  FFV2_0(w[28], w[48], w[10], pars->GC_101, amp[40]); 
  FFV1_0(w[28], w[45], w[9], pars->GC_11, amp[41]); 
  FFV2_0(w[15], w[49], w[10], pars->GC_101, amp[42]); 
  FFV1_0(w[13], w[49], w[9], pars->GC_11, amp[43]); 
  FFV1_0(w[13], w[48], w[6], pars->GC_11, amp[44]); 
  FFV1_0(w[1], w[45], w[50], pars->GC_11, amp[45]); 
  FFV1_0(w[15], w[45], w[6], pars->GC_11, amp[46]); 
  FFV1_0(w[13], w[44], w[50], pars->GC_11, amp[47]); 
  FFV1_0(w[52], w[7], w[46], pars->GC_11, amp[48]); 
  FFV1_0(w[51], w[12], w[46], pars->GC_11, amp[49]); 
  FFV1_0(w[52], w[7], w[47], pars->GC_11, amp[50]); 
  FFV1_0(w[51], w[12], w[47], pars->GC_11, amp[51]); 
  FFV2_0(w[53], w[25], w[10], pars->GC_101, amp[52]); 
  FFV1_0(w[52], w[25], w[9], pars->GC_11, amp[53]); 
  FFV2_0(w[54], w[17], w[10], pars->GC_101, amp[54]); 
  FFV1_0(w[54], w[12], w[9], pars->GC_11, amp[55]); 
  FFV1_0(w[53], w[12], w[6], pars->GC_11, amp[56]); 
  FFV1_0(w[52], w[7], w[50], pars->GC_11, amp[57]); 
  FFV1_0(w[52], w[17], w[6], pars->GC_11, amp[58]); 
  FFV1_0(w[51], w[12], w[50], pars->GC_11, amp[59]); 
  FFV1_0(w[1], w[12], w[56], pars->GC_11, amp[60]); 
  FFV1_0(w[13], w[7], w[56], pars->GC_11, amp[61]); 
  FFV1_0(w[1], w[12], w[57], pars->GC_11, amp[62]); 
  FFV1_0(w[1], w[58], w[46], pars->GC_11, amp[63]); 
  FFV1_0(w[13], w[7], w[57], pars->GC_11, amp[64]); 
  FFV1_0(w[59], w[7], w[46], pars->GC_11, amp[65]); 
  FFV1_0(w[1], w[12], w[61], pars->GC_11, amp[66]); 
  FFV1_0(w[13], w[7], w[61], pars->GC_11, amp[67]); 
  FFV1_0(w[1], w[12], w[62], pars->GC_11, amp[68]); 
  FFV1_0(w[1], w[58], w[47], pars->GC_11, amp[69]); 
  FFV1_0(w[13], w[7], w[62], pars->GC_11, amp[70]); 
  FFV1_0(w[59], w[7], w[47], pars->GC_11, amp[71]); 
  FFV2_0(w[15], w[63], w[10], pars->GC_101, amp[72]); 
  FFV1_0(w[13], w[63], w[9], pars->GC_11, amp[73]); 
  FFV1_0(w[1], w[27], w[64], pars->GC_11, amp[74]); 
  FFV1_0(w[13], w[25], w[64], pars->GC_11, amp[75]); 
  FFV1_0(w[13], w[65], w[0], pars->GC_11, amp[76]); 
  FFV1_0(w[15], w[27], w[0], pars->GC_11, amp[77]); 
  FFV2_0(w[66], w[17], w[10], pars->GC_101, amp[78]); 
  FFV1_0(w[66], w[12], w[9], pars->GC_11, amp[79]); 
  FFV1_0(w[29], w[7], w[64], pars->GC_11, amp[80]); 
  FFV1_0(w[28], w[12], w[64], pars->GC_11, amp[81]); 
  FFV1_0(w[67], w[12], w[0], pars->GC_11, amp[82]); 
  FFV1_0(w[29], w[17], w[0], pars->GC_11, amp[83]); 
  FFV1_0(w[1], w[12], w[68], pars->GC_11, amp[84]); 
  FFV1_0(w[69], w[12], w[6], pars->GC_11, amp[85]); 
  FFV1_0(w[13], w[7], w[68], pars->GC_11, amp[86]); 
  FFV1_0(w[13], w[70], w[6], pars->GC_11, amp[87]); 
  FFV1_0(w[1], w[12], w[71], pars->GC_11, amp[88]); 
  FFV1_0(w[1], w[58], w[50], pars->GC_11, amp[89]); 
  FFV1_0(w[13], w[7], w[71], pars->GC_11, amp[90]); 
  FFV1_0(w[59], w[7], w[50], pars->GC_11, amp[91]); 
  ...
  FFV1_0(w[1], w[12], w[74], pars->GC_11, amp[96]); 
  FFV1_0(w[1], w[12], w[75], pars->GC_11, amp[97]); 
  FFV1_0(w[1], w[12], w[76], pars->GC_11, amp[98]); 
  FFV1_0(w[13], w[7], w[74], pars->GC_11, amp[99]); 
  FFV1_0(w[13], w[7], w[75], pars->GC_11, amp[100]); 
  FFV1_0(w[13], w[7], w[76], pars->GC_11, amp[101]); 

}
double CPPProcess_P0_Sigma_sm_ckm_gs_ttxemvexgu::matrix_gs_ttxemvexgu() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 
  ...
  jamp[0] = +1./2. * (+amp[12] + amp[13] + amp[14] + amp[15] +
      ...
      amp[100]);
  jamp[1] = +1./2. * (-1./3. * amp[14] - 1./3. * amp[15] - 1./3. * amp[16] -
      1./3. * amp[17] - 1./3. * amp[21] - 1./3. * amp[23] - 1./3. * amp[26] -
      1./3. * amp[27] - 1./3. * amp[28] - 1./3. * amp[29] - 1./3. * amp[33] -
      1./3. * amp[35]);
  jamp[2] = +1./2. * (+amp[0] + amp[1] - std::complex<double> (0, 1) * amp[4] -
  ...
  jamp[3] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[8] + 1./3. *
      ...
      amp[66] - 1./3. * amp[67]);
  jamp[4] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[2] + 1./3. *
      ...
      * amp[43] - 1./3. * amp[44] - 1./3. * amp[46] - 1./3. * amp[78] - 1./3. *
      ...
      amp[95]);
  jamp[5] = +1./2. * (-amp[0] - amp[1] - std::complex<double> (0, 1) * amp[2] -
  ...
  jamp[7] = +1./2. * (+amp[24] + amp[25] + amp[28] + amp[29] -
      ...
      amp[99] + amp[100]);
  jamp[8] = +1./2. * (+amp[0] + amp[1] + std::complex<double> (0, 1) * amp[2] +
      std::complex<double> (0, 1) * amp[3] + std::complex<double> (0, 1) *
      amp[7] + std::complex<double> (0, 1) * amp[10] + std::complex<double> (0,
      ...
      amp[97] - amp[101] - amp[100]);
  jamp[9] = +1./2. * (-1./3. * std::complex<double> (0, 1) * amp[2] - 1./3. *
      std::complex<double> (0, 1) * amp[3] - 1./3. * std::complex<double> (0,
      1) * amp[4] - 1./3. * std::complex<double> (0, 1) * amp[5] - 1./3. *
      std::complex<double> (0, 1) * amp[6] - 1./3. * std::complex<double> (0,
      ...
      * amp[55] - 1./3. * amp[56] - 1./3. * amp[58] - 1./3. * amp[72] - 1./3. *
      ...
      amp[94]);
  jamp[10] = +1./2. * (-amp[0] - amp[1] + std::complex<double> (0, 1) * amp[4]
      + std::complex<double> (0, 1) * amp[5] + std::complex<double> (0, 1) *
      amp[6] + std::complex<double> (0, 1) * amp[8] + std::complex<double> (0,
      ...
      amp[96] + amp[101] - amp[99]);
  jamp[11] = +1./2. * (-1./3. * std::complex<double> (0, 1) * amp[8] - 1./3. *
      std::complex<double> (0, 1) * amp[9] - 1./3. * std::complex<double> (0,
      1) * amp[10] - 1./3. * std::complex<double> (0, 1) * amp[11] - 1./3. *

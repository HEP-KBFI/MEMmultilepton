...
#include "CPPProcess_P0_Sigma_sm_gu_epvemupmumgd.h"
#include "../../src/HelAmps_sm_gqlnullgq.h"
...
void CPPProcess_P0_Sigma_sm_gu_epvemupmumgd::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_gu_epvemupmumgd::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_gu_epvemupmumgd::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_gu_epvemupmumgd::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[8]); 
  ...
  FFV1_2(w[1], w[28], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV2_3(w[29], w[7], pars->GC_100, pars->mdl_MW, pars->mdl_WW, w[30]); 
  FFV1_1(w[7], w[28], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV2_3(w[1], w[31], pars->GC_100, pars->mdl_MW, pars->mdl_WW, w[32]); 
  FFV2_2(w[1], w[9], pars->GC_100, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_2(w[1], w[13], pars->GC_2, pars->ZERO, pars->ZERO, w[34]); 
  FFV2_5_2(w[1], w[19], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[35]);
  FFV1_1(w[7], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  ...
  FFV2_3(w[1], w[42], pars->GC_100, pars->mdl_MW, pars->mdl_WW, w[43]); 
  FFV1_2(w[37], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV2_3(w[44], w[7], pars->GC_100, pars->mdl_MW, pars->mdl_WW, w[45]); 
  ...
  FFV2_3_1(w[23], w[19], pars->GC_50, pars->GC_58, pars->ZERO, pars->ZERO,
      w[58]);
  FFV2_3(w[1], w[55], pars->GC_100, pars->mdl_MW, pars->mdl_WW, w[59]); 
  ...
  FFV2_0(w[10], w[7], w[18], pars->GC_100, amp[3]); 
  ...
  FFV2_0(w[10], w[7], w[22], pars->GC_100, amp[8]); 
  ...
  FFV2_0(w[29], w[7], w[18], pars->GC_100, amp[26]); 
  ...
  FFV2_0(w[1], w[31], w[18], pars->GC_100, amp[31]); 
  FFV1_0(w[33], w[15], w[28], pars->GC_11, amp[32]); 
  FFV1_0(w[34], w[17], w[28], pars->GC_11, amp[33]); 
  FFV2_0(w[29], w[7], w[22], pars->GC_100, amp[34]); 
  ...
  FFV2_0(w[1], w[31], w[22], pars->GC_100, amp[39]); 
  ...
  FFV2_0(w[1], w[42], w[18], pars->GC_100, amp[63]); 
  ...
  FFV2_0(w[1], w[42], w[22], pars->GC_100, amp[68]); 
  ...
  FFV2_0(w[44], w[7], w[18], pars->GC_100, amp[73]); 
  ...
  FFV2_0(w[44], w[7], w[22], pars->GC_100, amp[78]); 
  ...
  FFV2_0(w[1], w[55], w[18], pars->GC_100, amp[96]); 
  ...
  FFV2_0(w[1], w[55], w[22], pars->GC_100, amp[101]); 
...
double CPPProcess_P0_Sigma_sm_gu_epvemupmumgd::matrix_gu_epvemupmumgd() 
{
  int i, j; 
  // Local variables
  const int ncolor = 2; 

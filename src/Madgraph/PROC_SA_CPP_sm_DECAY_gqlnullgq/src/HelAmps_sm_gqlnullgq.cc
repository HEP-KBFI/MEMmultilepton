    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  P3[2] = V3[1].imag(); 
  P3[3] = V3[0].imag(); 
  TMP9 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  TMP8 = (P1[0] * V2[2] - P1[1] * V2[3] - P1[2] * V2[4] - P1[3] * V2[5]); 
  TMP5 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP7 = (V3[2] * P2[0] - V3[3] * P2[1] - V3[4] * P2[2] - V3[5] * P2[3]); 
  TMP6 = (V3[2] * P1[0] - V3[3] * P1[1] - V3[4] * P1[2] - V3[5] * P1[3]); 
  TMP11 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  TMP10 = (P3[0] * V2[2] - P3[1] * V2[3] - P3[2] * V2[4] - P3[3] * V2[5]); 
  TMP13 = (P3[0] * V1[2] - P3[1] * V1[3] - P3[2] * V1[4] - P3[3] * V1[5]); 
  TMP12 = (P2[0] * V1[2] - P2[1] * V1[3] - P2[2] * V1[4] - P2[3] * V1[5]); 
  vertex = COUP * (TMP11 * (-cI * (TMP12) + cI * (TMP13)) + (TMP5 * (-cI *
      (TMP6) + cI * (TMP7)) + TMP9 * (-cI * (TMP10) + cI * (TMP8))));
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP3 = (F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + cI * (V3[4]))) +
      F1[3] * (F2[4] * (V3[3] - cI * (V3[4])) + F2[5] * (V3[2] - V3[5])));
  vertex = COUP * - 1. * (+cI * (TMP3) + 4. * cI * (TMP4)); 
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (TMP11 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] * (-cI *
      (TMP6) + cI * (TMP7)) + V3[2] * (-cI * (TMP10) + cI * (TMP8))));
  V1[3] = denom * (TMP11 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] * (-cI *
      (TMP6) + cI * (TMP7)) + V3[3] * (-cI * (TMP10) + cI * (TMP8))));
  V1[4] = denom * (TMP11 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] * (-cI *
      (TMP6) + cI * (TMP7)) + V3[4] * (-cI * (TMP10) + cI * (TMP8))));
  V1[5] = denom * (TMP11 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] * (-cI *
      (TMP6) + cI * (TMP7)) + V3[5] * (-cI * (TMP10) + cI * (TMP8))));
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  P3[2] = -V3[1].imag(); 
  P3[3] = -V3[0].imag(); 
  TMP17 = (F1[4] * (F2[2] * (P3[0] - P3[3]) - F2[3] * (P3[1] + cI * (P3[2]))) +
  ...
  V3[3] = denom * - 2. * cI * (OM3 * - 1./2. * P3[1] * (TMP2 + 2. * (TMP17)) +
      ...
      F2[2]));
  V3[4] = denom * 2. * cI * (OM3 * 1./2. * P3[2] * (TMP2 + 2. * (TMP17)) +
      (+1./2. * cI * (F1[2] * F2[5]) - 1./2. * cI * (F1[3] * F2[4]) - cI *
      (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
  V3[5] = denom * 2. * cI * (OM3 * 1./2. * P3[3] * (TMP2 + 2. * (TMP17)) +
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  TMP14 = (P1[0] * P2[0] - P1[1] * P2[1] - P1[2] * P2[2] - P1[3] * P2[3]); 
  TMP7 = (V3[2] * P2[0] - V3[3] * P2[1] - V3[4] * P2[2] - V3[5] * P2[3]); 
  TMP6 = (V3[2] * P1[0] - V3[3] * P1[1] - V3[4] * P1[2] - V3[5] * P1[3]); 
  TMP11 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  TMP10 = (P3[0] * V2[2] - P3[1] * V2[3] - P3[2] * V2[4] - P3[3] * V2[5]); 
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (TMP11 * (-cI * (TMP15) + cI * (TMP14)) + (-cI
      * (TMP7 * TMP8) + cI * (TMP6 * TMP10))) + (TMP11 * (-cI * (P2[0]) + cI *
      (P3[0])) + (V2[2] * (-cI * (TMP6) + cI * (TMP7)) + V3[2] * (-cI * (TMP10)
      + cI * (TMP8)))));
  V1[3] = denom * (OM1 * P1[1] * (TMP11 * (-cI * (TMP15) + cI * (TMP14)) + (-cI
      * (TMP7 * TMP8) + cI * (TMP6 * TMP10))) + (TMP11 * (-cI * (P2[1]) + cI *
      (P3[1])) + (V2[3] * (-cI * (TMP6) + cI * (TMP7)) + V3[3] * (-cI * (TMP10)
      + cI * (TMP8)))));
  V1[4] = denom * (OM1 * P1[2] * (TMP11 * (-cI * (TMP15) + cI * (TMP14)) + (-cI
      * (TMP7 * TMP8) + cI * (TMP6 * TMP10))) + (TMP11 * (-cI * (P2[2]) + cI *
      (P3[2])) + (V2[4] * (-cI * (TMP6) + cI * (TMP7)) + V3[4] * (-cI * (TMP10)
      + cI * (TMP8)))));
  V1[5] = denom * (OM1 * P1[3] * (TMP11 * (-cI * (TMP15) + cI * (TMP14)) + (-cI
      * (TMP7 * TMP8) + cI * (TMP6 * TMP10))) + (TMP11 * (-cI * (P2[3]) + cI *
      (P3[3])) + (V2[5] * (-cI * (TMP6) + cI * (TMP7)) + V3[5] * (-cI * (TMP10)
      + cI * (TMP8)))));
}
    ...
    double M2, double W2, complex<double> V2[])
{
  ...
  denom = COUP/(pow(P2[0], 2) - pow(P2[1], 2) - pow(P2[2], 2) - pow(P2[3], 2) -
      M2 * (M2 - cI * W2));
  V2[2] = denom * (OM2 * P2[0] * (TMP9 * (-cI * (TMP14) + cI * (TMP16)) + (-cI
      * (TMP7 * TMP13) + cI * (TMP6 * TMP12))) + (TMP9 * (-cI * (P3[0]) + cI *
      (P1[0])) + (V1[2] * (-cI * (TMP6) + cI * (TMP7)) + V3[2] * (-cI * (TMP12)
      + cI * (TMP13)))));
  V2[3] = denom * (OM2 * P2[1] * (TMP9 * (-cI * (TMP14) + cI * (TMP16)) + (-cI
      * (TMP7 * TMP13) + cI * (TMP6 * TMP12))) + (TMP9 * (-cI * (P3[1]) + cI *
      (P1[1])) + (V1[3] * (-cI * (TMP6) + cI * (TMP7)) + V3[3] * (-cI * (TMP12)
      + cI * (TMP13)))));
  V2[4] = denom * (OM2 * P2[2] * (TMP9 * (-cI * (TMP14) + cI * (TMP16)) + (-cI
      * (TMP7 * TMP13) + cI * (TMP6 * TMP12))) + (TMP9 * (-cI * (P3[2]) + cI *
      (P1[2])) + (V1[4] * (-cI * (TMP6) + cI * (TMP7)) + V3[4] * (-cI * (TMP12)
      + cI * (TMP13)))));
  V2[5] = denom * (OM2 * P2[3] * (TMP9 * (-cI * (TMP14) + cI * (TMP16)) + (-cI
      * (TMP7 * TMP13) + cI * (TMP6 * TMP12))) + (TMP9 * (-cI * (P3[3]) + cI *
      (P1[3])) + (V1[5] * (-cI * (TMP6) + cI * (TMP7)) + V3[5] * (-cI * (TMP12)
      + cI * (TMP13)))));
}


}  // end namespace $(namespace)s_sm_gqlnullgq

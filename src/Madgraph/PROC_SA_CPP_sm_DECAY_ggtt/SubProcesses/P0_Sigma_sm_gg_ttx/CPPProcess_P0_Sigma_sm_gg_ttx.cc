...
#include "CPPProcess_P0_Sigma_sm_gg_ttx.h"
#include "../../src/HelAmps_sm_ggtt.h"

using namespace MG5_sm_ggtt; 
...
void CPPProcess_P0_Sigma_sm_gg_ttx::initProc(string param_card_name) 
{
  // Instantiate the model class and set parameters that stay fixed during run
  pars = Parameters_sm_ggtt::getInstance(); 
...
void CPPProcess_P0_Sigma_sm_gg_ttx::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_gg_ttx::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_gg_ttx::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_gg_ttx::matrix_gg_ttx() 
{
  int i, j; 
  // Local variables
  const int ncolor = 2; 

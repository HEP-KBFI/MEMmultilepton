...
#ifndef MG5_Sigma_sm_no_b_mass_pptllq_ub_tepemd_H
#define MG5_Sigma_sm_no_b_mass_pptllq_ub_tepemd_H
...
class CPPProcess_P0_Sigma_sm_no_b_mass_ub_tepemd
{
  public:
...
#endif  // MG5_Sigma_sm_no_b_mass_pptllq_ub_tepemd_H

...
#include "CPPProcess_P0_Sigma_sm_no_b_mass_dbx_txepemu.h"
...
void CPPProcess_P0_Sigma_sm_no_b_mass_dbx_txepemu::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_no_b_mass_dbx_txepemu::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_no_b_mass_dbx_txepemu::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_no_b_mass_dbx_txepemu::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[0], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_0(w[13], w[5], w[9], pars->GC_2, amp[7]); 
  FFV2_0(w[14], w[5], w[7], pars->GC_100, amp[8]); 
  FFV2_5_0(w[13], w[5], w[10], pars->GC_51, pars->GC_58, amp[9]); 
  FFV2_0(w[15], w[5], w[7], pars->GC_100, amp[10]); 

}
double CPPProcess_P0_Sigma_sm_no_b_mass_dbx_txepemu::matrix_dbx_txepemu() 
{
  int i, j; 
  // Local variables

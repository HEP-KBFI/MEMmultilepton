...
#include "CPPProcess_P0_Sigma_sm_ckm_gc_ttxepvegd.h"
...
// Process: g c > t t~ e+ ve g d WEIGHTED=8
// Process: g c > t t~ mu+ vm g d WEIGHTED=8

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_P0_Sigma_sm_ckm_gc_ttxepvegd::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gc_ttxepvegd::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gc_ttxepvegd::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gc_ttxepvegd::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_ckm_gc_ttxepvegd::matrix_gc_ttxepvegd() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 

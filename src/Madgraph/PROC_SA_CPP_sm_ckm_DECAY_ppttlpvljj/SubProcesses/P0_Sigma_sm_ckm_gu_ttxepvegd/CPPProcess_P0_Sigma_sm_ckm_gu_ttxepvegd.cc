...
#include "CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegd.h"
#include "../../src/HelAmps_sm_ckm_ppttlpvljj.h"

using namespace MG5_sm_ckm_ppttlpvljj; 

//==========================================================================
// Class member functions for calculating the matrix elements for
// Process: g u > t t~ e+ ve g d WEIGHTED=8
// Process: g u > t t~ mu+ vm g d WEIGHTED=8
// Process: g c > t t~ e+ ve g s WEIGHTED=8
// Process: g c > t t~ mu+ vm g s WEIGHTED=8

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegd::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegd::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegd::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegd::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegd::matrix_gu_ttxepvegd() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 

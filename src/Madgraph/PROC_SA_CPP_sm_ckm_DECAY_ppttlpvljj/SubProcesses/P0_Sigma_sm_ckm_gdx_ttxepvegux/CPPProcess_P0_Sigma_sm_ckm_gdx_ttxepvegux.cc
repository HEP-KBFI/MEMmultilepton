...
#include "CPPProcess_P0_Sigma_sm_ckm_gdx_ttxepvegux.h"
...
void CPPProcess_P0_Sigma_sm_ckm_gdx_ttxepvegux::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gdx_ttxepvegux::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gdx_ttxepvegux::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gdx_ttxepvegux::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_ckm_gdx_ttxepvegux::matrix_gdx_ttxepvegux() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 

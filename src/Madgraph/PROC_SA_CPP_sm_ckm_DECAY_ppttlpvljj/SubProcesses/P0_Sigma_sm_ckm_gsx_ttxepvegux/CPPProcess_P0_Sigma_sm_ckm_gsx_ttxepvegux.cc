...
#include "CPPProcess_P0_Sigma_sm_ckm_gsx_ttxepvegux.h"
...
void CPPProcess_P0_Sigma_sm_ckm_gsx_ttxepvegux::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gsx_ttxepvegux::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gsx_ttxepvegux::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gsx_ttxepvegux::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_ckm_gsx_ttxepvegux::matrix_gsx_ttxepvegux() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 

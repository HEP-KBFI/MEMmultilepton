...
#include "CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegs.h"
...
void CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegs::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegs::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegs::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegs::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_ckm_gu_ttxepvegs::matrix_gu_ttxepvegs() 
{
  int i, j; 
  // Local variables
  const int ncolor = 12; 
